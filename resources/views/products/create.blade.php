...
<section>
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" name="price_buy" id="price_buy" placeholder="Enter Price Buy">
            @error('price_buy')
            <p class="text-danger">{{ $message }}</p>
            @enderror
        </div>
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" name="price_sell" id="price_sell" placeholder="Enter Price Sell">
            @error('price_sell')
            <p class="text-danger">{{ $message }}</p>
            @enderror
        </div>
